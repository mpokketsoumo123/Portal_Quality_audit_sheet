...
def get_data():
    ...
    spreadsheet = client.open_by_url("https://docs.google.com/spreadsheets/d/1Qi_wJmG-Y1rQaeF1bI51zuAPEP3f-iNdUwVk1RHpM0s/edit?usp=sharing")
...
# Open the Google Sheet by its URL or nam
    ...
    with col2:
        ...
        for i in dropdown1_values:
            dropdown1.append(i['Call_Time_Slot'])
        call_time_slot = st.selectbox("Call_Time_Slot:",dropdown1)
